 ...
 *
 * This file initializes and exports the Supabase client for use throughout the frontend application.
 *
 * Local Development Instructions:
 * 1. Run `supabase start` from the project root to launch the local Supabase database
